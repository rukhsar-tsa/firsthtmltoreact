...
export default function Home() {
  ...
  <React.Fragment>
      <header id="identity">
        <div className="logo">
            <Link to="index.html" className="logo-link" rel="home"> <img src="assets/images/logo.png" className="logo" alt=""/> </Link>
        </div>
    </header>
    <div id="site-menu">
    ...
    <div className="site-menu-toggle">
        <Link to="about.html#site-menu" className="ti"> <span className="screen-reader-text">Toggle navigation</span> </Link>
    </div>
            ...
            <div className="content">
                <div className="grid-container">
                    <div className="grid-column">
                        ...
                        </div> <Link to="#" className="btn ajax">Hire Me</Link> </div>
                </div>
            </div>
        </div>
                            ...
                            <div className="col-md-6">
                                <div className="feature feature-left">
                                    ...
                                    <div className="mccan-text">
                                        <h3>Web Desing</h3>
                                        <p>Fusce suscipit, ante Link hendrerit thelery ullamcorper vivense comtersa risus nisl cursus nurus the viverra ante nulla.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6">
    ...
    <div className="additional-menu-content">
        ...
        <p>Hi, My name is Rory McCan. I am Link Web Designer, and etiam accumsan scelerisque rhoncus. Nulla quis laoreet velit. Pelteqle quisu velleopha retra congue.</p> <Link to="#" className="btn">Hire Me</Link>
